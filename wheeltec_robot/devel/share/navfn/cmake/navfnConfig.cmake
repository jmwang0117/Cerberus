...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /root/wheeltec_robot/src/navigation-melodic/navfn)
  set(navfn_DEVEL_PREFIX /root/wheeltec_robot/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /root/wheeltec_robot/install)
...
if(NOT "/root/wheeltec_robot/devel/include;/root/wheeltec_robot/src/navigation-melodic/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/root/wheeltec_robot/devel/include;/root/wheeltec_robot/src/navigation-melodic/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/wheeltec_robot/src/navigation-melodic/navfn/${idir}'.  ${_report}")
    endif()
