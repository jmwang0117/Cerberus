...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /root/wheeltec_robot/src/navigation-melodic/amcl)
  set(amcl_DEVEL_PREFIX /root/wheeltec_robot/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /root/wheeltec_robot/install)
...
if(NOT "/root/wheeltec_robot/devel/include;/root/wheeltec_robot/src/navigation-melodic/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/root/wheeltec_robot/devel/include;/root/wheeltec_robot/src/navigation-melodic/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/wheeltec_robot/src/navigation-melodic/amcl/${idir}'.  ${_report}")
    endif()
