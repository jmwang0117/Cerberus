...
if("TRUE" STREQUAL "TRUE")
  set(bodyreader_SOURCE_PREFIX /root/wheeltec_robot/src/bodyreader)
  set(bodyreader_DEVEL_PREFIX /root/wheeltec_robot/devel)
  ...
  set(bodyreader_INSTALL_PREFIX /root/wheeltec_robot/install)
...
if(NOT "/root/wheeltec_robot/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bodyreader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/wheeltec_robot/src/bodyreader/${idir}'.  ${_report}")
    endif()
