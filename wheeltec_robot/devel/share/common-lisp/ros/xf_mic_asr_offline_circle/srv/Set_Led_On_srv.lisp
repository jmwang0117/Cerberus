...
(cl:defmethod cl:initialize-instance :after ((m <Set_Led_On_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Led_On_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Set_Led_On_srv-request> is deprecated: use xf_mic_asr_offline_circle-srv:Set_Led_On_srv-request instead.")))

(cl:ensure-generic-function 'led_id-val :lambda-list '(m))
(cl:defmethod led_id-val ((m <Set_Led_On_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_circle-srv:led_id-val is deprecated.  Use xf_mic_asr_offline_circle-srv:led_id instead.")
  (led_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Led_On_srv-request>)))
  ...
  "xf_mic_asr_offline_circle/Set_Led_On_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Led_On_srv-request)))
  "Returns string type for a service object of type 'Set_Led_On_srv-request"
  "xf_mic_asr_offline_circle/Set_Led_On_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Set_Led_On_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Led_On_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Set_Led_On_srv-response> is deprecated: use xf_mic_asr_offline_circle-srv:Set_Led_On_srv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Led_On_srv-response>)))
  ...
  "xf_mic_asr_offline_circle/Set_Led_On_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Led_On_srv-response)))
  "Returns string type for a service object of type 'Set_Led_On_srv-response"
  "xf_mic_asr_offline_circle/Set_Led_On_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Led_On_srv)))
  ...
  "xf_mic_asr_offline_circle/Set_Led_On_srv")