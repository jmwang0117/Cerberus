...
(cl:defmethod cl:initialize-instance :after ((m <Set_Awake_Word_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Awake_Word_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Set_Awake_Word_srv-request> is deprecated: use xf_mic_asr_offline_circle-srv:Set_Awake_Word_srv-request instead.")))

(cl:ensure-generic-function 'awake_word-val :lambda-list '(m))
(cl:defmethod awake_word-val ((m <Set_Awake_Word_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_circle-srv:awake_word-val is deprecated.  Use xf_mic_asr_offline_circle-srv:awake_word instead.")
  (awake_word m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Awake_Word_srv-request>)))
  ...
  "xf_mic_asr_offline_circle/Set_Awake_Word_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Awake_Word_srv-request)))
  "Returns string type for a service object of type 'Set_Awake_Word_srv-request"
  "xf_mic_asr_offline_circle/Set_Awake_Word_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Set_Awake_Word_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Awake_Word_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Set_Awake_Word_srv-response> is deprecated: use xf_mic_asr_offline_circle-srv:Set_Awake_Word_srv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Awake_Word_srv-response>)))
  ...
  "xf_mic_asr_offline_circle/Set_Awake_Word_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Awake_Word_srv-response)))
  "Returns string type for a service object of type 'Set_Awake_Word_srv-response"
  "xf_mic_asr_offline_circle/Set_Awake_Word_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Awake_Word_srv)))
  ...
  "xf_mic_asr_offline_circle/Set_Awake_Word_srv")