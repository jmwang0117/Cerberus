...
(cl:defmethod cl:initialize-instance :after ((m <Get_Major_Mic_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Get_Major_Mic_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Get_Major_Mic_srv-request> is deprecated: use xf_mic_asr_offline_circle-srv:Get_Major_Mic_srv-request instead.")))

(cl:ensure-generic-function 'get_major_id-val :lambda-list '(m))
(cl:defmethod get_major_id-val ((m <Get_Major_Mic_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_circle-srv:get_major_id-val is deprecated.  Use xf_mic_asr_offline_circle-srv:get_major_id instead.")
  (get_major_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Get_Major_Mic_srv-request>)))
  ...
  "xf_mic_asr_offline_circle/Get_Major_Mic_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Major_Mic_srv-request)))
  "Returns string type for a service object of type 'Get_Major_Mic_srv-request"
  "xf_mic_asr_offline_circle/Get_Major_Mic_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Get_Major_Mic_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Get_Major_Mic_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Get_Major_Mic_srv-response> is deprecated: use xf_mic_asr_offline_circle-srv:Get_Major_Mic_srv-response instead.")))
...
(cl:defmethod mic_id-val ((m <Get_Major_Mic_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_circle-srv:mic_id-val is deprecated.  Use xf_mic_asr_offline_circle-srv:mic_id instead.")
  (mic_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Get_Major_Mic_srv-response>)))
  ...
  "xf_mic_asr_offline_circle/Get_Major_Mic_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Major_Mic_srv-response)))
  "Returns string type for a service object of type 'Get_Major_Mic_srv-response"
  "xf_mic_asr_offline_circle/Get_Major_Mic_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Major_Mic_srv)))
  ...
  "xf_mic_asr_offline_circle/Get_Major_Mic_srv")