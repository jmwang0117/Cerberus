...
(cl:defmethod cl:initialize-instance :after ((m <Start_Record_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start_Record_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Start_Record_srv-request> is deprecated: use xf_mic_asr_offline_circle-srv:Start_Record_srv-request instead.")))

(cl:ensure-generic-function 'whether_start-val :lambda-list '(m))
(cl:defmethod whether_start-val ((m <Start_Record_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_circle-srv:whether_start-val is deprecated.  Use xf_mic_asr_offline_circle-srv:whether_start instead.")
  (whether_start m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Start_Record_srv-request>)))
  ...
  "xf_mic_asr_offline_circle/Start_Record_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Start_Record_srv-request)))
  "Returns string type for a service object of type 'Start_Record_srv-request"
  "xf_mic_asr_offline_circle/Start_Record_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Start_Record_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start_Record_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_circle-srv:<Start_Record_srv-response> is deprecated: use xf_mic_asr_offline_circle-srv:Start_Record_srv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Start_Record_srv-response>)))
  ...
  "xf_mic_asr_offline_circle/Start_Record_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Start_Record_srv-response)))
  "Returns string type for a service object of type 'Start_Record_srv-response"
  "xf_mic_asr_offline_circle/Start_Record_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Start_Record_srv)))
  ...
  "xf_mic_asr_offline_circle/Start_Record_srv")