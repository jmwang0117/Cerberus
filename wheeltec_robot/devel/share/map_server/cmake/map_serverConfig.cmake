...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /root/wheeltec_robot/src/navigation-melodic/map_server)
  set(map_server_DEVEL_PREFIX /root/wheeltec_robot/devel)
  ...
  set(map_server_INSTALL_PREFIX /root/wheeltec_robot/install)
...
if(NOT "/root/wheeltec_robot/src/navigation-melodic/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/root/wheeltec_robot/src/navigation-melodic/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/wheeltec_robot/src/navigation-melodic/map_server/${idir}'.  ${_report}")
    endif()
