...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.color = 0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Params_colorConfig::AbstractParamDescriptionConstPtr(new Params_colorConfig::ParamDescription<int>("color", "int", 0, "chose present HSV thrshold", "{'enum_description': 'Preset HSV threshold list', 'enum': [{'srcline': 9, 'description': 'Use dynamic threshold', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Dynamic'}, {'srcline': 10, 'description': 'Preset HSV threshold of Red', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Red'}, {'srcline': 11, 'description': 'Preset HSV threshold of Blue', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Blue'}, {'srcline': 12, 'description': 'Preset HSV threshold of Green', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Green'}, {'srcline': 13, 'description': 'Preset HSV threshold of Yellow', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Yellow'}]}", &Params_colorConfig::color)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Params_colorConfig::AbstractParamDescriptionConstPtr(new Params_colorConfig::ParamDescription<int>("color", "int", 0, "chose present HSV thrshold", "{'enum_description': 'Preset HSV threshold list', 'enum': [{'srcline': 9, 'description': 'Use dynamic threshold', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Dynamic'}, {'srcline': 10, 'description': 'Preset HSV threshold of Red', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Red'}, {'srcline': 11, 'description': 'Preset HSV threshold of Blue', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Blue'}, {'srcline': 12, 'description': 'Preset HSV threshold of Green', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Green'}, {'srcline': 13, 'description': 'Preset HSV threshold of Yellow', 'srcfile': '/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Yellow'}]}", &Params_colorConfig::color)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.HSV_H_MIN = 0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg"
      const int Params_color_Dynamic = 0;
//#line 10 "/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg"
      const int Params_color_Red = 1;
//#line 11 "/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg"
      const int Params_color_Blue = 2;
//#line 12 "/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg"
      const int Params_color_Green = 3;
//#line 13 "/root/wheeltec_robot/src/simple_follower/cfg/Params_color.cfg"
